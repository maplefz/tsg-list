import { createContext, useContext, Component, computed, provideContext, signal, isBoolean, prop, effect, setAttribute, uppercaseFirstChar, isNil, noop, isString, isFunction, unwrap, camelToKebabCase, onDispose, scoped, keysOf, isArray, tick, peek, isKeyboardClick } from './vidstack-fG_Sx3Q9.js';
import { useMediaContext, useMediaState } from './vidstack-DQ4Fz5gz.js';
import { watchColorScheme, useResizeObserver, useActive } from './vidstack-DdUZGy1h.js';
import { html } from 'lit-html';
import { $signal, LayoutIconsLoader, Icon } from './vidstack--haiOhLb.js';
...
import { getDownloadFile } from './vidstack-n2fuk8wF.js';
...
class DefaultLayoutIconsLoader extends LayoutIconsLoader {
  async _load() {
    const paths = (await import('./vidstack-Bn_JCtSb.js')).icons, icons = {};
