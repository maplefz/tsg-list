import { createContext, useContext, Component, computed, provideContext, signal, isBoolean, prop, effect, setAttribute, uppercaseFirstChar, isNil, noop, isString, isFunction, unwrap, camelToKebabCase, onDispose, scoped, keysOf, isArray, tick, peek, isKeyboardClick } from './vidstack-C6myozhB.js';
import { useMediaContext, useMediaState } from './vidstack-Cq-GdDcp.js';
import { watchColorScheme, useResizeObserver, useActive } from './vidstack-BeyDmEgV.js';
import { html } from 'lit-html';
import { $signal, LayoutIconsLoader, Icon } from './vidstack-BUfQcGbf.js';
...
import { getDownloadFile } from './vidstack-Vi2h5MrZ.js';
...
class DefaultLayoutIconsLoader extends LayoutIconsLoader {
  async Pf() {
    const paths = (await import('./vidstack-CmqqnRgc.js')).icons, icons = {};
