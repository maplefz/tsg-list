...
declare class VimeoProvider extends EmbedProvider<VimeoMessage> implements Pick<VimeoParams, 'title' | 'byline' | 'portrait' | 'color'> {
    ...
    protected _currentSrc: Src<string> | null;
    protected _fullscreenActive: boolean;
    protected _seekableRange: TimeRange;
    protected _timeRAF: RAFLoop;
    protected _currentCue: VTTCue | null;
    protected _chaptersTrack: TextTrack | null;
    protected _promises: Map<string, DeferredPromise<any, string>[]>;
    ...
    protected _onAnimationFrame(): void;
    protected _preventTimeUpdates: boolean;
    ...
    protected _onReady(duration: number, trigger: Event): void;
    ...
    protected _onEvent<T extends keyof VimeoEventPayload>(event: T, payload: VimeoEventPayload[T], trigger: Event): void;
    ...
    protected _remote<T extends keyof VimeoCommandArg>(command: T, arg?: VimeoCommandArg[T]): Promise<void | undefined>;
    protected _reset(): void;
    protected _getPromise(command: VimeoCommand): DeferredPromise<any, string> | undefined;
}

/**
 * @see {@link https://developers.google.com/youtube/iframe_api_reference#Playback_controls}
 */
type YouTubeCommand = 'playVideo' | 'pauseVideo' | 'seekTo' | 'mute' | 'unMute' | 'setVolume' | 'setPlaybackRate';
...
declare class YouTubeProvider extends EmbedProvider<YouTubeMessage> implements MediaProviderAdapter, Pick<YouTubeParams, 'color' | 'start' | 'end'> {
    ...
    destroy(): void;
    play(): Promise<void | undefined>;
    protected _playFail(message: string): void;
    pause(): Promise<void | undefined>;
    protected _pauseFail(message: string): void;
    setMuted(muted: boolean): void;
    setCurrentTime(time: number): void;
    setVolume(volume: number): void;
    setPlaybackRate(rate: number): void;
    ...
    protected _remote<T extends keyof YouTubeCommandArg>(command: T, arg?: YouTubeCommandArg[T]): Promise<void | undefined>;
    protected _onLoad(): void;
    ...
    protected _reset(): void;
    protected _getPromise(command: YouTubeCommand): DeferredPromise<any, string> | undefined;
}
