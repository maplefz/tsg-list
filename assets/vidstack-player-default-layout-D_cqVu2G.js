const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vidstack-CmqqnRgc-D3v8FsP9.js","assets/app-0L92bSoP.js"])))=>i.map(i=>d[i]);
var we=Object.getPrototypeOf;var ke=Reflect.get;var lt=(e,t,s)=>ke(we(e),s,t);import{f as b,g as Vt,h as E,p as Et,i as C,j as Ce,k as G,u as S,l as Ae,C as De,m as Me,s as x,w as Wt,n as Oe,q as F,t as W,v as Ie,x as Ht,y as h,z as Kt,A as Pe,B as _e,D as Qt,E as U,F as $t,G as Ge,H as Ut,I as Ne,J as Be,K as Le,L as Fe,M as O,N as Re,O as Ve,P as zt,Q as rt,R as Ee,S as We,T as He,U as Ke,V as jt}from"./app-0L92bSoP.js";import{A as I,T as Qe,D as Nt,x as l,s as Ue,$ as ze,L as qt}from"./vidstack-D2YigfqZ-BLArkuQb.js";/**
 * @license
 ...
 */const R=(e,t)=>{var s,n;const i=e._$AN;if(i===void 0)return!1;for(const o of i)(n=(s=o)._$AO)===null||n===void 0||n.call(s,t,!1),R(o,t);return!0},j=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while((s==null?void 0:s.size)===0)},Zt=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),ts(t)}};function Je(e){this._$AN!==void 0?(j(this),this._$AM=e,Zt(this)):this._$AM=e}function Xe(e,t=!1,s=0){const n=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(n))for(let o=s;o<n.length;o++)R(n[o],!1),j(n[o]);else n!=null&&(R(n,!1),j(n));else R(this,e)}const ts=e=>{var t,s,n,i;e.type==z.CHILD&&((t=(n=e)._$AP)!==null&&t!==void 0||(n._$AP=Xe),(s=(i=e)._$AQ)!==null&&s!==void 0||(i._$AQ=Je))};class Yt extends gt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,n){super._$AT(t,s,n),Zt(this),this.isConnected=t._$AU}_$AO(t,s=!0){var n,i;t!==this.isConnected&&(this.isConnected=t,t?(n=this.reconnected)===null||n===void 0||n.call(this):(i=this.disconnected)===null||i===void 0||i.call(this)),s&&(R(this,t),j(this))}setValue(t){if(qe(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}class es extends Yt{constructor(t){super(t),this.h=null,this.w=!1,this.$=null,this.w=t.type===z.ATTRIBUTE||t.type===z.BOOLEAN_ATTRIBUTE}render(t){return t!==this.h&&(this.disconnected(),this.h=t,this.isConnected&&this.Gl()),this.h?this.x(Et(this.h)):I}reconnected(){this.Gl()}disconnected(){var t;(t=this.$)==null||t.call(this),this.$=null}Gl(){this.h&&(this.$=C(this.l.bind(this)))}x(t){return this.w?bt(t):t}y(t){this.setValue(this.x(t))}l(){var t;this.y((t=this.h)==null?void 0:t.call(this))}}function a(e){return J(es)(b(e))}class Jt{constructor(t,s){this._m=t,this.La=s,this.elements=new Set,this.Gc=Vt(this.Ha.bind(this))}connect(){this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0,subtree:!0});E(()=>t.disconnect()),E(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){Ce(t)?(s.textContent="",s.append(t)):(Nt(null,s),Nt(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const i=s.getAttribute("data-class");i&&n.classList.add(...i.split(" "))}Ha(t){if(t&&!t.some(i=>i.addedNodes.length))return;let s=!1,n=this._m.flatMap(i=>[...i.querySelectorAll("slot")]);for(const i of n)!i.hasAttribute("name")||this.elements.has(i)||(this.elements.add(i),s=!0);s&&this.La(this.elements)}}let ss=0,Q="data-slot-id";class Xt{constructor(t){this._m=t,this.Gc=Vt(this.Ha.bind(this)),this.slots=new Jt(t,this.Ha.bind(this))}connect(){this.slots.connect(),this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0});E(()=>t.disconnect())}Ha(){for(const t of this._m)for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let i=s.getAttribute(Q);i||s.setAttribute(Q,i=++ss+"");for(const o of this.slots.elements){if(o.getAttribute("name")!==n||o.getAttribute(Q)===i)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,o),o.setAttribute(Q,i)}}}}function ns({name:e,class:t,state:s,paths:n,viewBox:i="0 0 32 32"}){return l`<svg
  ...
  `}function ne({tooltip:e}){const{translations:t}=u(),{remotePlaybackState:s}=h(),n=a(()=>{const o=T(t,"Google Cast"),r=Kt(s());return`${o} ${r}`}),i=d(t,"Google Cast");return l`
  ...
  `}function tt({tooltip:e}){const{translations:t}=u(),s=d(t,"Play"),n=d(t,"Pause");return l`
  ...
  `}function Bt({tooltip:e,ref:t=Be}){const{translations:s}=u(),n=d(s,"Mute"),i=d(s,"Unmute");return l`
  ...
  `}function Tt({tooltip:e}){const{translations:t}=u(),s=d(t,"Closed-Captions On"),n=d(t,"Closed-Captions Off");return l`
  ...
  `}function us(){const{translations:e}=u(),t=d(e,"Enter PiP"),s=d(e,"Exit PiP");return l`
  ...
  `}function ie({tooltip:e}){const{translations:t}=u(),s=d(t,"Enter Fullscreen"),n=d(t,"Exit Fullscreen");return l`
  ...
  `}function Lt({backward:e,tooltip:t}){const{translations:s,seekStep:n}=u(),i=e?"Seek Backward":"Seek Forward",o=d(s,i);return l`
  ...
  `}function ae(){const{translations:e}=u(),{live:t}=h(),s=d(e,"Skip To Live"),n=d(e,"LIVE");return t()?l`
        <media-live-button class="vds-live-button" aria-label=${s}>
          <span class="vds-live-button-text">${n}</span>
        </media-live-button>
      `:null}function St(){return a(()=>{const{download:e,translations:t}=u(),s=e();if(Pe(s))return null;const{source:n,title:i}=h(),o=n(),r=_e({title:i(),src:o,download:s});return r?l`
        ...
        `:null})}function wt(){const{translations:e}=u();return l`
    <media-captions
      class="vds-captions"
  ...
  `}const Ss={...cs,upIcon:"menu-opacity-up",downIcon:"menu-opacity-down"},Ct={...ps,upIcon:"menu-opacity-up",downIcon:"menu-opacity-down"};function ws(){return a(()=>{const{hasCaptions:e}=h(),{translations:t}=u();return e()?l`
  ...
  `}function it({label:e,checked:t,defaultChecked:s=!1,storageKey:n,onChange:i}){const{translations:o}=u(),r=n?localStorage.getItem(n):null,p=x(!!(r??s)),c=x(!1),$=a(ze(p)),v=d(o,e);n&&i(Et(p)),t&&C(()=>void p.set(t()));function m(y){(y==null?void 0:y.button)!==1&&(p.set(B=>!B),n&&localStorage.setItem(n,p()?"1":""),i(p(),y),c.set(!1))}function f(y){Re(y)&&m()}function g(y){y.button===0&&c.set(!0)}return l`
    <div
      ...
      @keydown=${f}
    ></div>
  `}function Ns(){return a(()=>{const{translations:e}=u();return l`
    ...
    `})}function Bs(){const{userPrefersAnnouncements:e,translations:t}=u(),s="Announcements";return K({label:d(t,s),children:it({label:s,storageKey:"vds-player::announcements",onChange(n){e.set(n)}})})}function Ls(){return a(()=>{const{translations:e,userPrefersKeyboardAnimations:t,noKeyboardAnimations:s}=u(),{viewType:n}=h();if(b(()=>n()!=="video"||s())())return null;const o="Keyboard Animations";return K({label:d(e,o),children:it({label:o,defaultChecked:!0,storageKey:"vds-player::keyboard-animations",onChange(r){t.set(r)}})})})}function Fs(){return a(()=>{const{noAudioGain:e,translations:t}=u(),{audioTracks:s,canSetAudioGain:n}=h();return b(()=>!(n()&&!e())&&s().length<=1)()?null:l`
    ...
    `})}function Rs(){return a(()=>{const{translations:e}=u(),{audioTracks:t}=h(),s=d(e,"Default");return b(()=>t().length<=1)()?null:k({children:l`
      ...
      `})})}function Vs(){return a(()=>{const{noAudioGain:e,translations:t}=u(),{canSetAudioGain:s}=h();if(b(()=>!s()||e())())return null;const{audioGain:i}=h();return k({label:d(t,"Boost"),value:a(()=>Math.round(((i()??1)-1)*100)+"%"),children:[nt({upIcon:"menu-audio-boost-up",downIcon:"menu-audio-boost-down",children:Es(),isMin:()=>((i()??1)-1)*100<=ue(),isMax:()=>((i()??1)-1)*100===de()})]})})}function Es(){const{translations:e}=u(),t=d(e,"Boost"),s=ue,n=de,i=Ws;return l`
  ...
  `}function ue(){const{audioGains:e}=u(),t=e();return O(t)?t[0]??0:t.min}function de(){const{audioGains:e}=u(),t=e();return O(t)?t[t.length-1]??300:t.max}function Ws(){const{audioGains:e}=u(),t=e();return O(t)?t[1]-t[0]||25:t.step}function Hs(){return a(()=>{const{translations:e}=u(),{hasCaptions:t}=h(),s=d(e,"Off");return t()?l`
    ...
    `:null})}function Ks(){return a(()=>{const{translations:e}=u();return l`
  ...
  `}function qs(){const{remote:e,qualities:t}=S(),{autoQuality:s,canSetQuality:n,qualities:i}=h(),{translations:o}=u(),r="Auto";return b(()=>!n()||i().length<=1)()?null:K({label:d(o,r),children:it({label:r,checked:s,onChange(c,$){c?e.requestAutoQuality($):e.changeQuality(t.selectedIndex,$)}})})}function Zs(){return a(()=>{const{hideQualityBitrate:e,translations:t}=u(),{canSetQuality:s,qualities:n,quality:i}=h(),o=b(()=>!s()||n().length<=1),r=b(()=>Ue(n()));return o()?null:k({label:d(t,"Quality"),value:a(()=>{var m,f;const p=(m=i())==null?void 0:m.height,c=e()?null:(f=i())==null?void 0:f.bitrate,$=c&&c>0?`${(c/1e6).toFixed(2)} Mbps`:null,v=T(t,"Auto");return p?`${p}p${$?` (${$})`:""}`:v}),children:[nt({upIcon:"menu-quality-up",downIcon:"menu-quality-down",children:Ys(),isMin:()=>r()[0]===i(),isMax:()=>r().at(-1)===i()}),qs()]})})}function Ys(){const{translations:e}=u(),t=d(e,"Quality");return l`
    <media-quality-slider class="vds-quality-slider vds-slider" aria-label=${t}>
      ${et()}${st()}
    </media-quality-slider>
  `}function me({placement:e,portal:t,tooltip:s}){return a(()=>{const{viewType:n}=h(),{translations:i,menuPortal:o,noModal:r,menuGroup:p,smallWhen:c}=u(),$=b(()=>r()?U(e):c()?null:U(e)),v=b(()=>!c()&&p()==="bottom"&&n()==="video"?26:0),m=x(!1);fs();function f(){m.set(!0)}function g(){m.set(!1)}const y=l`
      <media-menu-items
    ...
    `})}function Js({orientation:e}={}){const{translations:t}=u(),s=d(t,"Volume");return l`
    <media-volume-slider
  ...
  `}function Dt(){const e=x(void 0),t=x(0),{thumbnails:s,translations:n,sliderChaptersMinWidth:i,disableTimeSlider:o,seekStep:r,noScrubGesture:p}=u(),c=d(n,"Seek"),$=a(o),v=a(()=>t()<i()),m=a(s);return Ut(e,()=>{const f=e();f&&t.set(f.clientWidth)}),l`
    <media-time-slider
 ...
 */const on=J(class extends gt{constructor(){super(...arguments),this.key=I}render(e,t){return this.key=e,t}update(e,[t,s]){return t!==this.key&&(Ye(e),this.key=t),s}}),V=class V extends N{};V.props={...lt(V,V,"props"),when:({viewType:t})=>t==="video",smallWhen:({width:t,height:s})=>t<576||s<380};let ft=V;function be(){return a(()=>{const e=S(),{noKeyboardAnimations:t,userPrefersKeyboardAnimations:s}=u();if(b(()=>t()||!s())())return null;const i=x(!1),{lastKeyboardAction:o}=e.$state;C(()=>{i.set(!!o());const m=setTimeout(()=>i.set(!1),500);return()=>{i.set(!1),window.clearTimeout(m)}});const r=b(()=>{var f;const m=(f=o())==null?void 0:f.action;return m&&i()?W(m):null}),p=b(()=>`vds-kb-action${i()?"":" hidden"}`),c=b(ln),$=b(()=>{const m=rn();return m?Ke(m):null});function v(){const m=$();return m?l`
    ...
    `]}function dn(){return a(()=>{const{menuGroup:e}=u();return e()==="bottom"?Mt():null})}function cn(){return l`
    <media-controls-group class="vds-controls-group">
  ...
  `}function Mt(){const{menuGroup:e,smallWhen:t}=u(),s=()=>e()==="top"||t()?"bottom":"top",n=b(()=>`${s()} ${e()==="top"?"end":"center"}`),i=b(()=>`${s()} end`);return[re({tooltip:n,placement:i,portal:!0}),me({tooltip:n,placement:i,portal:!0})]}function ge(){return a(()=>{const{noGestures:e}=u();return e()?null:l`
